			...
			<el-tab-pane label="全局配置" name="main">
				<el-form label-width="180px" label-position="left">
					...
					<el-form-item label="允许生成的进程数：">
						<el-input-number
							v-model="result.worker_processes"
							style="width: 164px"
			...
			<el-tab-pane label="events配置" name="events">
				<el-form label-width="180px" label-position="left">
					...
					<el-form-item label="最大连接数：">
						<el-input-number
							v-model="result.events.worker_connections"
							style="width: 164px"
							controls-position="right"
						></el-input-number>
					</el-form-item>
				...
				<div class="nginx-show">
					<pre ref="download"
						>{{
							result.is_window
								? ""
								: `user ${result.user.info} ${result.user.group};\n`
...
events{
    ...
    multi_accept {{ result.events.multi_accept ? "on" : "off" }};{{
							result.isWindow
								? ""
