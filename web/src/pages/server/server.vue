    ...
    <el-card class="server-main">
        ...
        <div>
            <div class="nginx-option">
                <el-button size="mini" type="primary" @click="open_add_server">新增服务器</el-button>
                <el-dropdown size="small" type="primary" style="padding-left: 12px">
                    <el-button size="mini" type="primary">安装</el-button>
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item @click.native="install_server(1)">安装Nginx</el-dropdown-item>
                        <el-dropdown-item @click.native="install_server(2)">安装Apache</el-dropdown-item>
                        <el-dropdown-item @click.native="install_server(3)">安装Tomcat</el-dropdown-item>
                        <el-dropdown-item @click.native="install_server(3)">安装Redis</el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
                ...
                <el-table :data="servers" style="width: 100%">
                    ...
                    <el-table-column label="操作" width="180">
                        <template slot-scope="scope">
                            <el-button type="text" size="mini" @click="open_info(scope.row.id)">查看</el-button>
        ...
        <el-dialog title="新增服务器" :visible.sync="server_dialog" :modal-append-to-body="false" destroy-on-close :close-on-click-modal="false" width="50%">
