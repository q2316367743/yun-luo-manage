<template>
	<el-card class="server-info">
		...
		<el-tabs tab-position="top" style="margin-top: 52px">
			...
			<el-tab-pane label="操作命令">
				...
				<div class="add_button">
					<el-button type="text" @click="command_dialog = true"
						>新增</el-button
					>
				</div>
			</el-tab-pane>
		...
		>
			...
			<span slot="footer" class="dialog-footer">
				<el-button @click="command_dialog_close">取 消</el-button>
...
export default {
	...
	methods: {
		...
		command_dialog_close() {
			this.command_dialog = false;
			document.getElementsByClassName("v-modal").forEach((element) => {
				element.remove();
			});
		},
